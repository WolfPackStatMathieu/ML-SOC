"""
INFO:root:Mean accuracy: 0.9996350407600403, Standard Deviation: 0.00028007367248488173
INFO:root:Mean precision: 0.9944774508476257, Standard Deviation: 0.008577436208724976
INFO:root:Mean recall: 0.995428740978241, Standard Deviation: 0.0016861732583492994
INFO:root:Mean F1-score: 0.9904862642288208, Standard Deviation: 0.007726667448878288
"""
import numpy as np
import pandas as pd
...
def preprocess_data(urls):
    ...
    for i, url in enumerate(urls):
        ascii_values = [ord(char) for char in url[:max_length]]
